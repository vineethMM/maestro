...
import au.com.cba.omnia.maestro.benchmark.thrift.{Struct10, Struct20, Struct30, Struct230, Struct500, HStruct10, HStruct230, Generators}
...
object CodecBenchmark extends PerformanceTest.OfflineReport {
  ...
  performance of "Codecs" in {
    ...
    measure method "decode[Struct230]" in testDecode[Struct230](Generators.struct230Rows)
    ...
    measure method "encode[Struct230]" in testEncode[Struct230](Generators.struct230Values)
    ...
    measure method "decode[HStruct230]"  in testDecode[HStruct230](Generators.hstruct230Rows)
  }
}
