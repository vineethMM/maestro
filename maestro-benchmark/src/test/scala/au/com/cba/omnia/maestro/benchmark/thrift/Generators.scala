...
object Generators extends Serializable {
  ...
  def mkStruct230Values(rows: Int): Array[Struct230] =
    (0 until rows).map { row =>
      val x = new Struct230
      x.str1    = s"r$row-f0"
      x.str2    = s"r$row-f1"
      x.dbl3    = row * 230 + 2.5
      x.int4    = row * 230 + 3
      x.long5   = Int.MaxValue + row * 230 + 4
      x.str6    = s"r$row-f5"
      x.str7    = s"r$row-f6"
      x.dbl8    = row * 230 + 7.5
      x.int9    = row * 230 + 8
      x.long10  = Int.MaxValue + row * 230 + 9
      x.str11   = s"r$row-f10"
      x.str12   = s"r$row-f11"
      x.dbl13   = row * 230 + 12.5
      x.int14   = row * 230 + 13
      x.long15  = Int.MaxValue + row * 230 + 14
      x.str16   = s"r$row-f15"
      x.str17   = s"r$row-f16"
      x.dbl18   = row * 230 + 17.5
      x.int19   = row * 230 + 18
      x.long20  = Int.MaxValue + row * 230 + 19
      x.str21   = s"r$row-f20"
      x.str22   = s"r$row-f21"
      x.dbl23   = row * 230 + 22.5
      x.int24   = row * 230 + 23
      x.long25  = Int.MaxValue + row * 230 + 24
      x.str26   = s"r$row-f25"
      x.str27   = s"r$row-f26"
      x.dbl28   = row * 230 + 27.5
      x.int29   = row * 230 + 28
      x.long30  = Int.MaxValue + row * 230 + 29
      x.str31   = s"r$row-f30"
      x.str32   = s"r$row-f31"
      x.dbl33   = row * 230 + 32.5
      x.int34   = row * 230 + 33
      x.long35  = Int.MaxValue + row * 230 + 34
      x.str36   = s"r$row-f35"
      x.str37   = s"r$row-f36"
      x.dbl38   = row * 230 + 37.5
      x.int39   = row * 230 + 38
      x.long40  = Int.MaxValue + row * 230 + 39
      x.str41   = s"r$row-f40"
      x.str42   = s"r$row-f41"
      x.dbl43   = row * 230 + 42.5
      x.int44   = row * 230 + 43
      x.long45  = Int.MaxValue + row * 230 + 44
      x.str46   = s"r$row-f45"
      x.str47   = s"r$row-f46"
      x.dbl48   = row * 230 + 47.5
      x.int49   = row * 230 + 48
      x.long50  = Int.MaxValue + row * 230 + 49
      x.str51   = s"r$row-f50"
      x.str52   = s"r$row-f51"
      x.dbl53   = row * 230 + 52.5
      x.int54   = row * 230 + 53
      x.long55  = Int.MaxValue + row * 230 + 54
      x.str56   = s"r$row-f55"
      x.str57   = s"r$row-f56"
      x.dbl58   = row * 230 + 57.5
      x.int59   = row * 230 + 58
      x.long60  = Int.MaxValue + row * 230 + 59
      x.str61   = s"r$row-f60"
      x.str62   = s"r$row-f61"
      x.dbl63   = row * 230 + 62.5
      x.int64   = row * 230 + 63
      x.long65  = Int.MaxValue + row * 230 + 64
      x.str66   = s"r$row-f65"
      x.str67   = s"r$row-f66"
      x.dbl68   = row * 230 + 67.5
      x.int69   = row * 230 + 68
      x.long70  = Int.MaxValue + row * 230 + 69
      x.str71   = s"r$row-f70"
      x.str72   = s"r$row-f71"
      x.dbl73   = row * 230 + 72.5
      x.int74   = row * 230 + 73
      x.long75  = Int.MaxValue + row * 230 + 74
      x.str76   = s"r$row-f75"
      x.str77   = s"r$row-f76"
      x.dbl78   = row * 230 + 77.5
      x.int79   = row * 230 + 78
      x.long80  = Int.MaxValue + row * 230 + 79
      x.str81   = s"r$row-f80"
      x.str82   = s"r$row-f81"
      x.dbl83   = row * 230 + 82.5
      x.int84   = row * 230 + 83
      x.long85  = Int.MaxValue + row * 230 + 84
      x.str86   = s"r$row-f85"
      x.str87   = s"r$row-f86"
      x.dbl88   = row * 230 + 87.5
      x.int89   = row * 230 + 88
      x.long90  = Int.MaxValue + row * 230 + 89
      x.str91   = s"r$row-f90"
      x.str92   = s"r$row-f91"
      x.dbl93   = row * 230 + 92.5
      x.int94   = row * 230 + 93
      x.long95  = Int.MaxValue + row * 230 + 94
      x.str96   = s"r$row-f95"
      x.str97   = s"r$row-f96"
      x.dbl98   = row * 230 + 97.5
      x.int99   = row * 230 + 98
      x.long100 = Int.MaxValue + row * 230 + 99
      x.str101  = s"r$row-f100"
      x.str102  = s"r$row-f101"
      x.dbl103  = row * 230 + 102.5
      x.int104  = row * 230 + 103
      x.long105 = Int.MaxValue + row * 230 + 104
      x.str106  = s"r$row-f105"
      x.str107  = s"r$row-f106"
      x.dbl108  = row * 230 + 107.5
      x.int109  = row * 230 + 108
      x.long110 = Int.MaxValue + row * 230 + 109
      x.str111  = s"r$row-f110"
      x.str112  = s"r$row-f111"
      x.dbl113  = row * 230 + 112.5
      x.int114  = row * 230 + 113
      x.long115 = Int.MaxValue + row * 230 + 114
      x.str116  = s"r$row-f115"
      x.str117  = s"r$row-f116"
      x.dbl118  = row * 230 + 117.5
      x.int119  = row * 230 + 118
      x.long120 = Int.MaxValue + row * 230 + 119
      x.str121  = s"r$row-f120"
      x.str122  = s"r$row-f121"
      x.dbl123  = row * 230 + 122.5
      x.int124  = row * 230 + 123
      x.long125 = Int.MaxValue + row * 230 + 124
      x.str126  = s"r$row-f125"
      x.str127  = s"r$row-f126"
      x.dbl128  = row * 230 + 127.5
      x.int129  = row * 230 + 128
      x.long130 = Int.MaxValue + row * 230 + 129
      x.str131  = s"r$row-f130"
      x.str132  = s"r$row-f131"
      x.dbl133  = row * 230 + 132.5
      x.int134  = row * 230 + 133
      x.long135 = Int.MaxValue + row * 230 + 134
      x.str136  = s"r$row-f135"
      x.str137  = s"r$row-f136"
      x.dbl138  = row * 230 + 137.5
      x.int139  = row * 230 + 138
      x.long140 = Int.MaxValue + row * 230 + 139
      x.str141  = s"r$row-f140"
      x.str142  = s"r$row-f141"
      x.dbl143  = row * 230 + 142.5
      x.int144  = row * 230 + 143
      x.long145 = Int.MaxValue + row * 230 + 144
      x.str146  = s"r$row-f145"
      x.str147  = s"r$row-f146"
      x.dbl148  = row * 230 + 147.5
      x.int149  = row * 230 + 148
      x.long150 = Int.MaxValue + row * 230 + 149
      x.str151  = s"r$row-f150"
      x.str152  = s"r$row-f151"
      x.dbl153  = row * 230 + 152.5
      x.int154  = row * 230 + 153
      x.long155 = Int.MaxValue + row * 230 + 154
      x.str156  = s"r$row-f155"
      x.str157  = s"r$row-f156"
      x.dbl158  = row * 230 + 157.5
      x.int159  = row * 230 + 158
      x.long160 = Int.MaxValue + row * 230 + 159
      x.str161  = s"r$row-f160"
      x.str162  = s"r$row-f161"
      x.dbl163  = row * 230 + 162.5
      x.int164  = row * 230 + 163
      x.long165 = Int.MaxValue + row * 230 + 164
      x.str166  = s"r$row-f165"
      x.str167  = s"r$row-f166"
      x.dbl168  = row * 230 + 167.5
      x.int169  = row * 230 + 168
      x.long170 = Int.MaxValue + row * 230 + 169
      x.str171  = s"r$row-f170"
      x.str172  = s"r$row-f171"
      x.dbl173  = row * 230 + 172.5
      x.int174  = row * 230 + 173
      x.long175 = Int.MaxValue + row * 230 + 174
      x.str176  = s"r$row-f175"
      x.str177  = s"r$row-f176"
      x.dbl178  = row * 230 + 177.5
      x.int179  = row * 230 + 178
      x.long180 = Int.MaxValue + row * 230 + 179
      x.str181  = s"r$row-f180"
      x.str182  = s"r$row-f181"
      x.dbl183  = row * 230 + 182.5
      x.int184  = row * 230 + 183
      x.long185 = Int.MaxValue + row * 230 + 184
      x.str186  = s"r$row-f185"
      x.str187  = s"r$row-f186"
      x.dbl188  = row * 230 + 187.5
      x.int189  = row * 230 + 188
      x.long190 = Int.MaxValue + row * 230 + 189
      x.str191  = s"r$row-f190"
      x.str192  = s"r$row-f191"
      x.dbl193  = row * 230 + 192.5
      x.int194  = row * 230 + 193
      x.long195 = Int.MaxValue + row * 230 + 194
      x.str196  = s"r$row-f195"
      x.str197  = s"r$row-f196"
      x.dbl198  = row * 230 + 197.5
      x.int199  = row * 230 + 198
      x.long200 = Int.MaxValue + row * 230 + 199
      x.str201  = s"r$row-f200"
      x.str202  = s"r$row-f201"
      x.dbl203  = row * 230 + 202.5
      x.int204  = row * 230 + 203
      x.long205 = Int.MaxValue + row * 230 + 204
      x.str206  = s"r$row-f205"
      x.str207  = s"r$row-f206"
      x.dbl208  = row * 230 + 207.5
      x.int209  = row * 230 + 208
      x.long210 = Int.MaxValue + row * 230 + 209
      x.str211  = s"r$row-f210"
      x.str212  = s"r$row-f211"
      x.dbl213  = row * 230 + 212.5
      x.int214  = row * 230 + 213
      x.long215 = Int.MaxValue + row * 230 + 214
      x.str216  = s"r$row-f215"
      x.str217  = s"r$row-f216"
      x.dbl218  = row * 230 + 217.5
      x.int219  = row * 230 + 218
      x.long220 = Int.MaxValue + row * 230 + 219
      x.str221  = s"r$row-f220"
      x.str222  = s"r$row-f221"
      x.dbl223  = row * 230 + 222.5
      x.int224  = row * 230 + 223
      x.long225 = Int.MaxValue + row * 230 + 224
      x.str226  = s"r$row-f225"
      x.str227  = s"r$row-f226"
      x.dbl228  = row * 230 + 227.5
      x.int229  = row * 230 + 228
      x.long230 = Int.MaxValue + row * 230 + 229
  ...
  val struct230Values: Gen[Array[Struct230]] =
    Gen.enumeration("rows")(10000, 30000).map(mkStruct230Values(_))
  ...
  /** Generator for rows which can be parsed into [[Struct30]]s */
  val struct230Rows: Gen[Array[List[String]]] =
    struct230Values.map(_.map(mkRow))
  ...
  def mkHStruct230Values(rows: Int): Array[HStruct230] =
    (0 until rows).map { row =>
      new HStruct230( s"r$row-f0" :: s"r$row-f1" :: row * 230 + 2.5 :: row * 230 + 3 :: Int.MaxValue.toLong + row * 230 + 4 :: s"r$row-f5" :: s"r$row-f6" :: row * 230 + 7.5 :: row * 230 + 8 :: Int.MaxValue.toLong + row * 230 + 9 ::  s"r$row-f10" :: s"r$row-f11" :: row * 230 + 12.5 :: row * 230 + 13 :: Int.MaxValue.toLong + row * 230 + 14 :: s"r$row-f15" :: s"r$row-f16" :: row * 230 + 17.5 :: row * 230 + 18 :: Int.MaxValue.toLong + row * 230 + 19 ::  s"r$row-f20" :: s"r$row-f21" :: row * 230 + 22.5 :: row * 230 + 23 :: Int.MaxValue.toLong + row * 230 + 24 :: s"r$row-f25" :: s"r$row-f26" :: row * 230 + 27.5 :: row * 230 + 28 :: Int.MaxValue.toLong + row * 230 + 29 ::  s"r$row-f30" :: s"r$row-f31" :: row * 230 + 32.5 :: row * 230 + 33 :: Int.MaxValue.toLong + row * 230 + 34 :: s"r$row-f35" :: s"r$row-f36" :: row * 230 + 37.5 :: row * 230 + 38 :: Int.MaxValue.toLong + row * 230 + 39 ::  s"r$row-f40" :: s"r$row-f41" :: row * 230 + 42.5 :: row * 230 + 43 :: Int.MaxValue.toLong + row * 230 + 44 :: s"r$row-f45" :: s"r$row-f46" :: row * 230 + 47.5 :: row * 230 + 48 :: Int.MaxValue.toLong + row * 230 + 49 ::  s"r$row-f50" :: s"r$row-f51" :: row * 230 + 52.5 :: row * 230 + 53 :: Int.MaxValue.toLong + row * 230 + 54 :: s"r$row-f55" :: s"r$row-f56" :: row * 230 + 57.5 :: row * 230 + 58 :: Int.MaxValue.toLong + row * 230 + 59 ::  s"r$row-f60" :: s"r$row-f61" :: row * 230 + 62.5 :: row * 230 + 63 :: Int.MaxValue.toLong + row * 230 + 64 :: s"r$row-f65" :: s"r$row-f66" :: row * 230 + 67.5 :: row * 230 + 68 :: Int.MaxValue.toLong + row * 230 + 69 ::  s"r$row-f70" :: s"r$row-f71" :: row * 230 + 72.5 :: row * 230 + 73 :: Int.MaxValue.toLong + row * 230 + 74 :: s"r$row-f75" :: s"r$row-f76" :: row * 230 + 77.5 :: row * 230 + 78 :: Int.MaxValue.toLong + row * 230 + 79 ::  s"r$row-f80" :: s"r$row-f81" :: row * 230 + 82.5 :: row * 230 + 83 :: Int.MaxValue.toLong + row * 230 + 84 :: s"r$row-f85" :: s"r$row-f86" :: row * 230 + 87.5 :: row * 230 + 88 :: Int.MaxValue.toLong + row * 230 + 89 ::  s"r$row-f90" :: s"r$row-f91" :: row * 230 + 92.5 :: row * 230 + 93 :: Int.MaxValue.toLong + row * 230 + 94 :: s"r$row-f95" :: s"r$row-f96" :: row * 230 + 97.5 :: row * 230 + 98 :: Int.MaxValue.toLong + row * 230 + 99 ::  s"r$row-f100" :: s"r$row-f101" :: row * 230 + 102.5 :: row * 230 + 103 :: Int.MaxValue.toLong + row * 230 + 104 :: s"r$row-f105" :: s"r$row-f106" :: row * 230 + 107.5 :: row * 230 + 108 :: Int.MaxValue.toLong + row * 230 + 109 ::  s"r$row-f110" :: s"r$row-f111" :: row * 230 + 112.5 :: row * 230 + 113 :: Int.MaxValue.toLong + row * 230 + 114 :: s"r$row-f115" :: s"r$row-f116" :: row * 230 + 117.5 :: row * 230 + 118 :: Int.MaxValue.toLong + row * 230 + 119 ::  s"r$row-f120" :: s"r$row-f121" :: row * 230 + 122.5 :: row * 230 + 123 :: Int.MaxValue.toLong + row * 230 + 124 :: s"r$row-f125" :: s"r$row-f126" :: row * 230 + 127.5 :: row * 230 + 128 :: Int.MaxValue.toLong + row * 230 + 129 ::  s"r$row-f130" :: s"r$row-f131" :: row * 230 + 132.5 :: row * 230 + 133 :: Int.MaxValue.toLong + row * 230 + 134 :: s"r$row-f135" :: s"r$row-f136" :: row * 230 + 137.5 :: row * 230 + 138 :: Int.MaxValue.toLong + row * 230 + 139 ::  s"r$row-f140" :: s"r$row-f141" :: row * 230 + 142.5 :: row * 230 + 143 :: Int.MaxValue.toLong + row * 230 + 144 :: s"r$row-f145" :: s"r$row-f146" :: row * 230 + 147.5 :: row * 230 + 148 :: Int.MaxValue.toLong + row * 230 + 149 ::  s"r$row-f150" :: s"r$row-f151" :: row * 230 + 152.5 :: row * 230 + 153 :: Int.MaxValue.toLong + row * 230 + 154 :: s"r$row-f155" :: s"r$row-f156" :: row * 230 + 157.5 :: row * 230 + 158 :: Int.MaxValue.toLong + row * 230 + 159 ::  s"r$row-f160" :: s"r$row-f161" :: row * 230 + 162.5 :: row * 230 + 163 :: Int.MaxValue.toLong + row * 230 + 164 :: s"r$row-f165" :: s"r$row-f166" :: row * 230 + 167.5 :: row * 230 + 168 :: Int.MaxValue.toLong + row * 230 + 169 ::  s"r$row-f170" :: s"r$row-f171" :: row * 230 + 172.5 :: row * 230 + 173 :: Int.MaxValue.toLong + row * 230 + 174 :: s"r$row-f175" :: s"r$row-f176" :: row * 230 + 177.5 :: row * 230 + 178 :: Int.MaxValue.toLong + row * 230 + 179 ::  s"r$row-f180" :: s"r$row-f181" :: row * 230 + 182.5 :: row * 230 + 183 :: Int.MaxValue.toLong + row * 230 + 184 :: s"r$row-f185" :: s"r$row-f186" :: row * 230 + 187.5 :: row * 230 + 188 :: Int.MaxValue.toLong + row * 230 + 189 ::  s"r$row-f190" :: s"r$row-f191" :: row * 230 + 192.5 :: row * 230 + 193 :: Int.MaxValue.toLong + row * 230 + 194 :: s"r$row-f195" :: s"r$row-f196" :: row * 230 + 197.5 :: row * 230 + 198 :: Int.MaxValue.toLong + row * 230 + 199 ::  s"r$row-f200" :: s"r$row-f201" :: row * 230 + 202.5 :: row * 230 + 203 :: Int.MaxValue.toLong + row * 230 + 204 :: s"r$row-f205" :: s"r$row-f206" :: row * 230 + 207.5 :: row * 230 + 208 :: Int.MaxValue.toLong + row * 230 + 209 ::  s"r$row-f210" :: s"r$row-f211" :: row * 230 + 212.5 :: row * 230 + 213 :: Int.MaxValue.toLong + row * 230 + 214 :: s"r$row-f215" :: s"r$row-f216" :: row * 230 + 217.5 :: row * 230 + 218 :: Int.MaxValue.toLong + row * 230 + 219 ::  s"r$row-f220" :: s"r$row-f221" :: row * 230 + 222.5 :: row * 230 + 223 :: Int.MaxValue.toLong + row * 230 + 224 :: s"r$row-f225" :: s"r$row-f226" :: row * 230 + 227.5 :: row * 230 + 228 :: Int.MaxValue.toLong + row * 230 + 229 :: HNil)
    }.toArray

  /** Generator for [[HStruct230]]s */
  val hstruct230Values: Gen[Array[HStruct230]] =
    Gen.enumeration("rows")(10000).map(mkHStruct230Values(_))

  /** Generator for rows which can be parsed into [[HStruct230]]s */
  val hstruct230Rows: Gen[Array[List[String]]] =
    hstruct230Values.map(_.map(mkRow))
