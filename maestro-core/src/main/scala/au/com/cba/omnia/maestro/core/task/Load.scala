...
trait Load {
  ...
  def load[A <: ThriftStruct : Decode : Tag : Manifest](
    ...
    LoadHelper.load(delimiter, sources, errors, timeSource, clean, validator, filter, none)(None)
  }
  ...
  def loadWithKey[A <: ThriftStruct : Decode : Tag : Manifest](
    ...
    LoadHelper.loadWithKey(delimiter, sources, errors, timeSource, clean, validator, filter, none)(None)
  ...
  def loadFixedLength[A <: ThriftStruct : Decode : Tag : Manifest](
    ...
    LoadHelper.loadFixedLength(lengths, sources, errors, timeSource, clean, validator, filter, none)(None)
}
